...
- **Скиллы**: поле `version` в YAML frontmatter (например `version: "6.2.2"`)
- **Команды**: поле `version` в YAML frontmatter (например `version: "6.2.2"`)
- **Пайплайны**: HTML-комментарий в первой строке (например `<!-- version: 6.2.2 -->`)
