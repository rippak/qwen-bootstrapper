...
| Версия | Что нового                                                                                                                 |
|--------|----------------------------------------------------------------------------------------------------------------------------|
| v6.2.3 | Anti-laziness: запрет на пропуск фаз «потому что задача простая», чеклисты в CHECKPOINT, post-dispatch валидация в роутере |
| v6.2.2 | Tool-usage-rules: единый блок правил работы с инструментами для ВСЕХ агентов, самовосстановление при ошибках |
| v6.2.1 | Жёсткие правила пайплайнов: запрет пропуска фаз, CHECKPOINT-валидация, enforce REVIEW/CAPTURE, подстановка команд          |
| v6.2.0 | Добавление обязательного условия в пайплайны                                                                               |
